...
>
    ...
    <div class="container project-show-container">
        ...
        <div class="project-show-layout">
            ...
            <aside class="project-show-sidebar">
                
                {{-- Card 1: Client Info --}}
                <div class="project-show-sidebar-card text-center">
                    ...
                    <div class="d-flex flex-column align-center mb-lg">
                        <img src="https://i.pravatar.cc/80?u=client2" alt="Client" class="project-show-client-avatar">
                    ...
                    <button class="btn btn--outline mb-md project-show-sidebar-btn" style="border-color: var(--color-border); color: var(--color-text-dark); background: transparent;">عرض ملف الشركة</button>
                    <button class="btn btn--outline project-show-sidebar-btn" style="border-color: var(--color-border); color: var(--color-text-dark); background: transparent;">
                ...
                <div class="project-show-sidebar-card">
                    ...
                    <div class="project-show-info-list text-sm">
                        <div class="project-show-info-row">
                ...
                <div class="project-show-sidebar-card text-center">
                    ...
                    <button class="btn btn--primary mb-md project-show-sidebar-btn text-md">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="22" y1="2" x2="11" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>
                        قدم عرضاً للمشروع
                    </button>
                    
                    <button class="btn btn--outline project-show-sidebar-btn text-md" style="border-color: var(--color-border); color: var(--color-text-dark); background: transparent;">
            ...
            <main class="project-show-main">
                
                {{-- Single Card for All Main Content --}}
                <div class="project-show-main-card">
                    ...
                    <div>
                        <div class="d-flex justify-between align-start mb-md">
                            ...
                            <div class="project-show-header-actions">
                                ...
                                <button class="btn btn--outline project-show-header-btn">
                    ...
                    {{-- Section 2: Stats Row --}}
                    <div class="project-show-stats-row">
                        <div class="project-show-stat-item">
                            <span class="text-muted text-xs">نشر في</span>
                            <span class="font-bold text-sm">15 مايو 2024</span>
                        </div>
                        <div class="project-show-stat-item">
                            <span class="text-muted text-xs">الموعد النهائي</span>
                            <span class="font-bold text-sm">15 يونيو 2024 <span class="text-primary text-xs">(30 يوم متبقي)</span></span>
                        </div>
                        <div class="project-show-stat-item">
                            <span class="text-muted text-xs">العروض</span>
                            <span class="font-bold text-sm">24 عرض</span>
                        </div>
                        <div class="project-show-stat-item">
                            <span class="text-muted text-xs">الموازنة</span>
                            <span class="font-bold text-primary text-sm">$1,200 - $2,500</span>
                        </div>
                        <div class="project-show-stat-item">
                            <span class="text-muted text-xs">نوع المشروع</span>
                    ...
                    <div class="project-show-details-grid">

                        {{-- Right Column in HTML (Visual left in RTL) --}}
                        <div class="project-show-info-column">
                            <div class="project-show-info-list">
                                <div class="project-show-info-row">
                                    <span class="text-sm font-bold">متوسط</span>
                                    <div class="project-show-info-label">
                        ...
                        {{-- Left Column in HTML (Visual right in RTL) --}}
                        <div class="card-data ">
                            <h2 class="project-show-section-title">
                            ...
                            <ul class="project-show-tasks-list">
                                <li class="project-show-task-item">
                    ...
                    <div>
                        ...
                        <div class="project-show-skills">
                            <span class="project-show-skill-tag">WordPress</span>
                            <span class="project-show-skill-tag">HTML/CSS</span>
                            <span class="project-show-skill-tag">JavaScript</span>
                            <span class="project-show-skill-tag">PHP</span>
                            <span class="project-show-skill-tag">UI/UX Design</span>
                            <span class="project-show-skill-tag">SEO</span>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="project-show-attachment">
                            <div class="project-show-attachment-icon">
                            ...
                            <div class="project-show-attachment-info">
